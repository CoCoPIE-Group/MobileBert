...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        # export to onnx
        onnx_model_path = f"{args.output_dir}/{args.model_type}L-12_H-256_A-4.onnx"
        ...
        # export to pth to run on mobile device
        traced_script_module = torch.jit.trace(model, (batch[0], batch[1]))
        traced_script_module.save(f"{args.output_dir}/{args.model_type}.pth")
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        ######################delete some layers
            ...
            #layer_list = model.distilbert.encoder.layer
