...
def train(args, train_dataset, model, tokenizer, args_ai):
    """ Train the model """
    ...
    CL.init(args=args_ai, model=model, optimizer=optimizer, data_loader=train_dataloader)
...
def training_main(args_ai=None):
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, model, tokenizer, args_ai)
