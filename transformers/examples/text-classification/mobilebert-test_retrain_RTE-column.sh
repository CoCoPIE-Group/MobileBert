...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  --model_name_or_path /data/ZLKong/mobilebert/prune/RTE_column \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 5e-5 \
  ...
  --block_row_width 8 \
  --output_dir /data/ZLKong/mobilebert/retrain/RTE_blcolumn_try \
  --overwrite_output_dir \
  --logging_steps 1500 \
  --logging_dir /data/ZLKong/mobilebert/retrain/RTE_blcolumn_try \
  --save_steps 4000
