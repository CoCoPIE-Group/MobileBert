...
export PRUNE_RATIO=mobilebert_prune_ratios_30
...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  ...
  --block_row_width 8 \
  --output_dir /data/ZLKong/mobilebert/retrain/RTE_blockfilter_30 \
  --overwrite_output_dir \
  --logging_steps 1500 \
  --logging_dir /data/ZLKong/mobilebert/retrain/RTE_blockfilter_30 \
  --save_steps 4000
