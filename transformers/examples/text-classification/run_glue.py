...
######################delete some layers
    ...
    #freeze_layers = training_args.freeze_layers
...
#####################################################
    ...
    # Get datasets
    train_dataset = (
        GlueDataset(data_args, tokenizer=tokenizer, mode="train",cache_dir=model_args.cache_dir) if training_args.do_train else None
    )
    eval_dataset = (
...
#########model reduction
    #remove_layers = training_args.remove_layers
